<script lang="ts">
  ...
  import type {
    ...
    ConversationsList as ConversationsListType,
    MessageItem
  ...
  export let fetchConversationsFunction: (
    page: number,
    pageSize: number
  ) => Promise<ConversationsListType[] | ConversationsListType>;
              ...
              <div class="flex items-center">
                ...
                <div class="flex space-x-3">
                  <button
                    on:click={() =>
                      goto(
                        `/admin/conversation/${conversation.session_id}?application=${application}`
                      )}
                          ...
                          {#if renderedMsg.role === 'assistant'}
                            <div class="rounded-md bg-blue-50 p-3 mb-2">
                              ...
                              <div class="prose prose-sm max-w-none inline-block align-top">
                                <SvelteMarkdown source={renderedMsg.content} />
                              </div>
                            </div>
