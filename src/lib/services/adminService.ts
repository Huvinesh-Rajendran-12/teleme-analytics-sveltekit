  ...
  try {
    ...
    try {
      ...
      const processedStats: UserActivityStats | null =
        analyticsRaw
          ? {
              dau: parseInt(analyticsRaw.daily_active_users || "0", 10) || 0,
              wau: parseInt(analyticsRaw.weekly_active_users || "0", 10) || 0,
              mau: parseInt(analyticsRaw.monthly_active_users || "0", 10) || 0,
              totalUsersEver: parseInt(analyticsRaw.total_users_ever || "0", 10) || 0,
              activeSessions: parseInt(analyticsRaw.active_sessions || "0", 10) || 0,
              inactiveSessions: parseInt(analyticsRaw.inactive_sessions || "0", 10) || 0,
              totalSessions: parseInt(analyticsRaw.total_sessions || "0", 10) || 0,
              avgSessionsPerUser: parseFloat(analyticsRaw.avg_sessions_per_user || "0") || 0,
              weeklyRetentionRate: parseFloat(analyticsRaw.weekly_retention_rate || "0") || 0,
              avgSessionMinutes: parseFloat(analyticsRaw.avg_session_minutes || "0") || 0,
              maxSessionMinutes: parseFloat(analyticsRaw.max_session_minutes || "0") || 0,
              newUsersToday: parseInt(analyticsRaw.new_users_today || "0", 10) || 0,
              newUsersThisWeek: parseInt(analyticsRaw.new_users_this_week || "0", 10) || 0,
              newUsersThisMonth: parseInt(analyticsRaw.new_users_this_month || "0", 10) || 0,
              mostRecentActivity: analyticsRaw.most_recent_activity || new Date(0).toISOString(),
              timeSinceLastActivity: analyticsRaw.time_since_last_activity || {
                hours: 0,
                minutes: 0,
                seconds: 0,
                milliseconds: 0,
  ...
  try {
    ...
    try {
      ...
      const processedStats: UserActivityStats | null =
        healthTrackerRaw
          ? {
              dau: parseInt(healthTrackerRaw.daily_active_users || "0", 10) || 0,
              wau: parseInt(healthTrackerRaw.weekly_active_users || "0", 10) || 0,
              mau: parseInt(healthTrackerRaw.monthly_active_users || "0", 10) || 0,
              totalUsersEver: parseInt(healthTrackerRaw.total_users_ever || "0", 10) || 0,
              activeSessions: parseInt(healthTrackerRaw.active_sessions || "0", 10) || 0,
              inactiveSessions: parseInt(healthTrackerRaw.inactive_sessions || "0", 10) || 0,
              totalSessions: parseInt(healthTrackerRaw.total_sessions || "0", 10) || 0,
              avgSessionsPerUser: parseFloat(healthTrackerRaw.avg_sessions_per_user || "0") || 0,
              weeklyRetentionRate: parseFloat(healthTrackerRaw.weekly_retention_rate || "0") || 0,
              avgSessionMinutes: parseFloat(healthTrackerRaw.avg_session_minutes || "0") || 0,
              maxSessionMinutes: parseFloat(healthTrackerRaw.max_session_minutes || "0") || 0,
              newUsersToday: parseInt(healthTrackerRaw.new_users_today || "0", 10) || 0,
              newUsersThisWeek: parseInt(healthTrackerRaw.new_users_this_week || "0", 10) || 0,
              newUsersThisMonth: parseInt(healthTrackerRaw.new_users_this_month || "0", 10) || 0,
              mostRecentActivity: healthTrackerRaw.most_recent_activity || new Date(0).toISOString(),
              timeSinceLastActivity: healthTrackerRaw.time_since_last_activity || {
                hours: 0,
                minutes: 0,
                seconds: 0,
                milliseconds: 0,
