  ...
  async function loadConversations(attempt = 1) {
    try {
      ...
      const result = await Promise.race([
        fetchAnalyticsChatbotConversations(currentPage, 10),
    ...
    <div class="mb-8">
      <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
        <div>
          ...
          <p class="text-gray-600 mt-2 max-w-3xl">
            Manage and monitor conversations from the Analytics Chatbot application. View user interactions, conversation details, and engagement metrics.
          </p>
        </div>
      ...
      <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label for="search" class="block text-xs font-medium text-gray-700 mb-1">Search Conversations</label>
          ...
          <div>
            <label for="date-range" class="block text-xs font-medium text-gray-700 mb-1">Date Range</label>
            <select
              id="date-range"
      ...
      >
        <div class="text-center">
          ...
          <p class="mt-2 text-sm text-gray-500 max-w-md mx-auto">
            There are no Analytics Chatbot conversations to display at this time. Check your filters or try again later.
          </p>
          <div class="mt-6">
            <button 
              on:click={() => loadConversations()} 
            ...
            <div class="flex flex-col md:flex-row md:justify-between md:items-center p-4">
              <div>
                <h3 class="font-medium text-gray-900 flex items-center">
                  <div class="h-6 w-6 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 flex-shrink-0 mr-2">
              ...
              <div class="flex items-center mt-2 md:mt-0">
                <span class="text-sm text-blue-700 mr-3 bg-blue-50 rounded-full px-2.5 py-1 font-medium">
                      ...
                      {#if msgItem}
                        {#if msgItem.message}
                          {#if msgItem.message.type === 'ai' || msgItem.message.type === 'assistant'}
                            <div class="rounded-xl bg-blue-50 border border-blue-100 p-3" in:fade={{ duration: 200, delay: index * 40 }}>
                              <div class="flex items-start">
                                <div class="h-7 w-7 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-white flex items-center justify-center text-xs font-bold mr-2 flex-shrink-0 shadow-sm">
                                  AI
                                </div>
                          ...
                          {:else}
                            <div class="rounded-xl bg-amber-50 border border-amber-100 p-3" in:fade={{ duration: 200, delay: index * 40 }}>
                              <div class="flex items-start">
                                <div class="h-7 w-7 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 text-white flex items-center justify-center text-xs font-bold mr-2 flex-shrink-0 shadow-sm">
                                  U
                                </div>
                                <div>
                        ...
                        {:else}
                          <div class="rounded-xl bg-gray-100 border border-gray-200 p-3" in:fade={{ duration: 200, delay: index * 40 }}>
                            <div class="flex items-start">
                              <div class="h-7 w-7 rounded-full bg-gray-500 text-white flex items-center justify-center text-xs font-bold mr-2 flex-shrink-0">
                                ?
                              </div>
                              <div>
