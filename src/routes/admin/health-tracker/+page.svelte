...
<AdminLayout>
  <div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
      <h1 class="text-2xl font-bold text-gray-900 mb-2 md:mb-0">Health Tracker Summary Conversations</h1>
    ...
    {:else}
      ...
      <div class="space-y-4">
        {#each conversations as conversation, i (conversation.session_id)}
          ...
          >
            <div class="flex flex-col md:flex-row md:justify-between md:items-center p-4 bg-gray-50">
              <div>
              ...
              <div class="flex items-center mt-2 md:mt-0">
                ...
                <div class="flex space-x-3">
                  <button
                    on:click={() => goto(`/admin/conversation/${conversation.session_id}?application=${APPLICATION_TYPES.HEALTH_TRACKER_SUMMARY}`)}
                    class="text-blue-600 hover:text-blue-800 rounded-full p-1 hover:bg-blue-50 transition-colors duration-150"
                  ...
                  <button
                    ...
                    class="text-gray-600 hover:text-gray-800 rounded-full p-1 hover:bg-gray-100 transition-colors duration-150"
                      ...
                      {#if msgItem}
                        {#if msgItem.message}
                          {#if msgItem.message.type === 'ai' || msgItem.message.type === 'assistant'}
                            <div class="rounded-md bg-blue-50 p-3" in:fade={{ duration: 200, delay: index * 40 }}>
                          ...
                          {:else}
                            <div class="rounded-md bg-amber-50 p-3" in:fade={{ duration: 200, delay: index * 40 }}>
                              <div class="flex items-start">
                          ...
                          {/if}
                        {:else}
                          <div class="rounded-md bg-gray-100 p-3" in:fade={{ duration: 200, delay: index * 40 }}>
                            <div class="flex items-start">
            ...
            {#each getPaginationNumbers() as page}
              ...
              {:else}
                <button
                  ...
                  class="relative inline-flex items-center px-4 py-2 border border-gray-300 {page === currentPage ? 'bg-blue-50 text-blue-600 z-10' : 'bg-white text-gray-500 hover:bg-gray-50'} text-sm font-medium"
                >
                  {page}
                </button>
              {/if}
