...
export const POST: RequestHandler = async ({ request }) => {
   try {
     ...
     logDebug('Login attempt for username:', loginUsername);
     ...
     const user = testUsers.find(u => u.username === loginUsername && u.password === password);
     ...
     logDebug('Login successful for user:', loginUsername);
